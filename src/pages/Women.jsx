...
import { useCart } from '../context/CartContext'; // Assuming Cart context exists
import { productsData } from '../assets/data'; // Assuming products data is available in data.js file
import { FiTag, FiBox, FiShield } from 'react-icons/fi'; // Use icons from react-icons
...
const WomenPage = () => {
  ...
  // List of subcategories for women
  const subcategories = [
      ...
      {popupImage && (
        ...
        >
          <div className="relative">
            <button
              className="absolute top-2 right-2 bg-red-500 text-black px-3 py-1 rounded-full text-xl font-bold"
              onClick={() => setPopupImage(null)}
            >
              ✕
            </button>
